    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-date-picker
          ...
          class="filter-item"
        />
        <el-input-number v-model="crud.query.onlineCount" placeholder="在线设备数量" style="width: 150px;" class="filter-item" :min="0" />
        <el-input-number v-model="crud.query.offlineCount" placeholder="离线设备数量" style="width: 150px;" class="filter-item" :min="0" />
        <el-input-number v-model="crud.query.alarmCount" placeholder="报警设备数量" style="width: 150px;" class="filter-item" :min="0" />
